...
class Ion_auth_model extends CI_Model
{
	...
	public function register($username, $password, $email, $additional_data = array(), $groups = array())
	{
		...
		// Insert default user settings to the user account
		$this->add_default_settings($id);
	...
	**/
	...
	public function add_default_settings($id)
	{
		// Check if records exist
		// Insert batch user settings for initial user
		$data = array(
			array(
			'user_id' => $id,
			'setting_code' => 'sms',
		...
		if($this->db->insert_batch('settings', $data))
		{
			return true;
		}
