<?php /* Smarty version Smarty-3.1.7, created on 2012-10-15 11:59:12
         compiled from "/Library/WebServer/Documents/mfarm-web/application/views/admin/settings/tips.tpl" */ ?>
<?php /*%%SmartyHeaderCode:770996977507bde706fa7a6-60593960%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '176fad3f76b068983670ef37bfeba5007fe62ea8' => 
    array (
      0 => '/Library/WebServer/Documents/mfarm-web/application/views/admin/settings/tips.tpl',
      1 => 1347967065,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '770996977507bde706fa7a6-60593960',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_507bde70889fe',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_507bde70889fe')) {function content_507bde70889fe($_smarty_tpl) {?><?php if (!is_callable('smarty_function_base_url')) include '/Library/WebServer/Documents/mfarm-web/application/third_party/Smarty/plugins/function.base_url.php';
...
admin/settings/delete_tip/<?php echo $_smarty_tpl->tpl_vars['tip']->value->id;?>
" class="close close-tip" onclick="return confirm('Are you sure you want to delete?')">×</a>
 ...
 <?php echo twitter_time_format($_smarty_tpl->tpl_vars['tip']->value->date_added);?>
</small>
	</blockquote>
<?php } ?>
<?php }else{ ?>
  ...
  <div class="modal-body">
  	<div id="" class="control-group">
		<div id="" class="controls">
			...
			<textarea name="tip" class="input-xlarge span12" rows="5"><?php echo set_value('tip');?>
</textarea>
		</div><!-- /controls-->
	</div><!-- /control-group -->
  </div>
