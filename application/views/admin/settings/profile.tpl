<div class="span8">
	<form id="edit-profile" class="form-horizontal" method="post" action="{base_url}admin/settings/profile/{$user->id}">
	<fieldset>
	...
	<div class="span4">
		...
		{/if}
		<br>
		<form class="well" action="{base_url}admin/settings/upload_photo/{$user->id}" method="post" enctype="multipart/form-data">
			<fieldset>
				<div class="control-group">
