<h1>Invitations</h1>
<form action="invitations" method="post" action="{base_url}admin/settings/invitations" class="form-inline well">
	<fieldset>
...
<div class="btn-toolbar">
	<div class="btn-group">
		<a class="btn" href="{base_url}admin/settings/invitations">All</a>
		<a class="btn" href="{base_url}admin/settings/invitations/active">Active</a>
		<a class="btn" href="{base_url}admin/settings/invitations/pending">Pending</a>
	</div>
</div>
