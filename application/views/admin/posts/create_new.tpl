<div class="page-header">
	<div class="pull-right">
		<div class="btn-group">
			<a href="{site_url('admin/posts')}" class="btn btn-success"><i class="icon-chevron-left icon-white"></i> Cancel</a>
		</div>
	</div>
...
<div class="row">
<div class="span7">
<form id="new-post" class="form-horizontal" method="post" action="{site_url('admin/posts/edit')}">
	<fieldset>
