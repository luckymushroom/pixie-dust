<div class="row-fluid">
	<div class="span7">
		...
		<form class="form-horizontal" method="post" action='{site_url("admin/posts/edit/{$post->id}")}'>
			<fieldset>
				...
				<div class="form-actions">
					...
					<a href="{site_url('admin/posts/')}" class="btn btn-warning">Done</a>
				</div>
			</fieldset>
		</form>
	</div><!-- / -->
	...
	{if ($post->post_photo)}
		<ul class="thumbnails">
			<li class="span7">
				<div class="thumbnail">
	      			<a href='{site_url("admin/posts/delete_photo/{$post->id}/")}' onclick="return confirm('Are you sure you want to delete this Photo?')" title="Delete Photo">
	...
	{/if}
	<!-- Upload form here -->
		<form class="form-inline" action='{site_url("admin/posts/upload_photo/{$post->id}")}' method="post" enctype="multipart/form-data">
			<fieldset>
				<div class="control-group">
					<div class="controls">
