...
<form class='form-vertical well' method='post' action='{site_url('products/update/')}'>
	<div class='control-group'>
		<label class='control-label'>Category Name</label>
		<div class='controls'>
			{form_dropdown('category_id', $categories)}
		</div>
	</div>
	...
	<div class='control-group'>
		...
		<div class='controls'>
			<textarea class='input-xlarge' name='product_alias'></textarea>
		</div>
	</div>
	<div class='controls'>
