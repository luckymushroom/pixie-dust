<div class="page-header">
	<h2>Price Item: #<?=$record->id?>  [<?=date('d-m-Y',strtotime($record->crop_date));?>]</h2>
</div>
<form action="<?=site_url('prices/edit/'.$record->id);?>" method="post" class="form-horizontal well">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="location_name" value="<?=$record->location;?>" readonly>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="controls">
		...
		<a href="<?=site_url('prices');?>" class="btn btn-warning">Cancel</a>
	</div>
</form>