<div class="page-header">
    ...
    <ul class="nav nav-pills">
    	<li><a href="{base_url}farmer/settings/tips">My Tips</a></li>
    	<li class="active"><a href="{base_url}farmer/settings/all_tips">All Tips</a></li>
    </ul>
...
<div class="modal hide fade" id="myModal">
  <form action="{base_url}farmer/settings/tips" method="post">
