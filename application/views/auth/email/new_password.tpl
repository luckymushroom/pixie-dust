...
<td style="background: #e9e9e9; color: #393939; font-family: arial, verdana; font-size: 25px;" width="576" align="center">Here is your Temporary Password for</td>
</tr><tr>
...
<tr><td style="background: #e9e9e9;" width="24"></td>
<td style="background: #e9e9e9; color: #707070; font-family: arial, verdana; font-size: 15px;" width="576" align="center">
	Your password has been reset to: <span style="color: #00b62f; text-decoration: none;" href="#">{$new_password}</span> 
	<br>Please change this once you login under Settings menu. <br><br> 
	Please click this link to {anchor("auth/login", "Login with Your Password")}..
</td>
<td style="background: #e9e9e9;" width="24"></td></tr>
</table>
<table cellpadding="0" cellspacing="0" border="0">
