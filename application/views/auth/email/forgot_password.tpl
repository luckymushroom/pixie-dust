...
<td style="background: #e9e9e9; color: #393939; font-family: arial, verdana; font-size: 25px;" width="576" align="center">Reset Password for</td>
</tr><tr>
...
<td style="background: #e9e9e9; color: #707070; font-family: arial, verdana; font-size: 15px;" width="576" align="center">
	...
	<span style="color: #00b62f; text-decoration: none;" href="#">
		{anchor("auth/reset_password/{$forgotten_password_code}", "Reset Your Password")}.
	</span><br><br>
	Another email with a temporary password will be sent to this email after clicking the above link.
</td>
<td style="background: #e9e9e9;" width="24"></td></tr>
</table>
<table cellpadding="0" cellspacing="0" border="0">
