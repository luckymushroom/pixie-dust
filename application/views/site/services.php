<div class="maincontent">
	...
	<div class="col-1">                
        ...
        <div class="pricingoffer-box">
        	<ul class="offer-list">
                ...
                <li class="offer-button"><a class="button-helios alt-gray" href="<?=base_url();?>"><span>only KES 200/month</span></a></li>
    ...
    <div class="col-3">
        ...
        <?php if ($this->session->userdata('user_id')): ?>
            <a class="button-helios alt-green" href="<?php echo base_url();?>members"><span>Back to User Panel</span></a>
        <?php else: ?>
            <a class="button-helios alt-green" href="<?php echo base_url();?>members/create_user"><span>sign up / free 30 day trial</span></a><br /><br />
