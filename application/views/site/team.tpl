...
<div class="maincontent">
	...
	<div class="col-1">
        ...
        <ul id="portfolio-list">
            ...
            <li class="founders"><!-- portfolio 3 -->
                <div class="pf-image">
                    ...
                    <div class="caption">
                        ...
                        <p>Current - Chief Operation Officer at M-Farm. Nimble and Quick on her feet, Susaneve does this "executes". She also doubles as a mobile developer and research junkie.She aspires to pour her entrepreneurial spirit into researching and launching mobile solutions for emerging economies.</p>
            ...
            <li><div class="pf-image"></div></li>
            <li class="others"><!-- portfolio 10 -->
                <div class="pf-image">
                    <img src="{base_url}media/img/portfolio-thumb/pf-thumb10.jpg" alt="Jimmy Wambua" title="Jimmy Wambua" />
                    <div class="caption">
                        <span class="header">Jimmy</span>
                        <p>Jimmy Wambua is a wordsmith with a background in Agriculture and Journalism. He has a firm grasp of the Agricultural landscape in Kenya and has also been a TV host, Script Writer and Produces Documentaries.Food Security is his pet subject and believes smallholder farmers hold the keys to the prosperity of the nations. When he is not with Farmers Jimmy is running around the slums as a social justice insider giving hope to children.</p>
                        <!-- <a class="fullscreen-img" href="#" rel="portfolio" title="Mfarm-Melvin-Marende">#</a>                                                   -->
                    </div>
                </div>
            </li>
