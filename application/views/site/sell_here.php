...
<meta name="description" content="Mfarm's sell page, fill in the form to sell your products with mfarm">
...
<!-- Apple iOS and Android stuff -->
    ...
    <title>MFarm Kenya | Sell Crops Here</title>
<!-- ////////////////////////////////// -->
<!-- //        Favicon Files         // -->
<!-- ////////////////////////////////// -->
...
<script type="text/javascript" src="<?=base_url();?>media/js/sell-form.js"></script>
...
<body>	
	<div id="container"> 
    	<div id="top-container">
            ...
            <!-- BEGIN OF PAGE TITLE -->
            <div id="page-title">
            	<h1>Sell you crops on mFarm</h1>
                <h6>Well, We want to help you sell more, too!</h6>	
            </div>
            <!-- END OF PAGE TITLE -->
                	...
                	<div class="col-2-3">
                    	<div class="envelop-content">                            
                            <div id="contactFormArea">
                                <!-- Contact Form Start //-->
                                <form action="<?=base_url();?>sell_submit" id="sellform" method="post"> 
                                    <fieldset>
