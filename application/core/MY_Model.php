...
class MY_Model extends CI_Model
{
    ...
    /**
     * Excluded table attributes for join statements
     */
    protected $excluded_attr = array('id','created_at','updated_at','deleted','location_id');
    ...
    public function __construct()
    {
        ...
        $this->soft_delete_key = $this->_table.'.deleted';
    ...
    public function get($primary_value)
    {
        ...
        $row = $this->db->where($this->_table. '.' .$this->primary_key, $primary_value)
                        ->get($this->_table)
                        ->{$this->_return_type()}();
        $this->_temporary_return_type = $this->return_type;
    ...
    public function join($table, $primary_key ='id', $join = 'left')
    {
        $columns = self::_attr_selected($table);
        $foreign_key = singular($table) . '_id';

        $this->db->select($this->_table.'.*');
        $this->db->select($columns);
        $this->db->join($table, $table.'.'.$primary_key. '=' .$this->_table.'.'.$foreign_key, $join);
        return $this;
    }
    ...
    /**
     * Return columns of join table minus excluded attributes
     */
    private function _attr_selected($table)
    {
        $fields = $this->db->list_fields($table);

        foreach ($this->excluded_attr as $key => $value) {
